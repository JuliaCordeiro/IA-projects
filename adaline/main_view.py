...
def make_window():
    ...
    layout = [[sg.MenubarCustom(menu_def, key='-MENU-')],
              ...
              [sg.HSeparator()],
              [sg.Column(input_grid_manager, vertical_alignment='top'),
               sg.Column(input_selectors_manager, vertical_alignment='top'),
...
def main():
    ...
    while True:
        ...
        if event in (None, 'Exit'):
            ...
            print(f'[LOG] Calling Train method on network_elements. Values=(learning_rate={learning_rate},'
                  f' max_epochs={max_epochs}, minimum_error={min_error})')
